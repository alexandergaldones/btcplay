...
<head>
   <meta charset="utf-8" />
   <title>Bitcoin Global Price Ƀ1 = {{ isset($prices['bitcoinaverage']['USD']['last']) ? $prices['bitcoinaverage']['USD']['last'] : 'Latest news and updates!' }}</title>
   <meta http-equiv="X-UA-Compatible" content="IE=edge">
   <meta content="width=device-width, initial-scale=1.0" name="viewport" />
   <meta content="" name="description" />
   <meta content="" name="country" />
   <meta content="" name="country" />
   <meta content="bitgp.com" name="author" />
   ...
   <link href="{{ asset('css/pages/tasks.css') }}" rel="stylesheet" type="text/css"/>
